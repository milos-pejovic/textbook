...
function web_development_custom_css(){ 
  ...
  .sidebar .widget h3:before,.blog_text h3.post_title:after,.sidebar .widget_tag_cloud .tagcloud a:hover,.footer-list .tagcloud a:hover,footer .footer-list .footer-title:after,#cssmenu > ul > li:hover, #cssmenu ul li.current_page_item:hover, #cssmenu ul li.current_page_item, #cssmenu ul li.has-sub.current_page_item:hover,.blog_details a.read-more:hover,#cssmenu ul ul li.has-sub:hover, #cssmenu ul li.has-sub ul li.has-sub ul li:hover,.page-numbers li:hover,#cssmenu ul.first_menu ul.sub-menu li:hover>a,.comment_title h3:after,p.form-submit input[type=submit]:hover,a.read_more:hover,#home-slider .owl-dots .owl-dot.active span, #home-slider .owl-dots .owl-dot:hover span,section.our_overview::before,.more a:hover,footer h4::after,.owl-theme .owl-dots .owl-dot.active span, .owl-theme .owl-dots .owl-dot:hover span{background-color: '.esc_attr(get_theme_mod('web_development_theme_color','#30bced')).';}  
  .cats.mb span>i,.scroll_top,.banner_text ul li>a,a,.banner_text ul li a:hover,.icon-box i,a:hover{color: '.esc_attr(get_theme_mod('web_development_theme_color','#30bced')).';}
  ...
  $custom_css .='.banner { margin-top: -128px; }  .slider { margin-top: -128px; }
